module Printify
  class BlueprintFactory < ::AbstractFactory
    ...
    def create(
      blueprint_attributes: default_blueprint_attributes,
    ...
    def stub_blueprint_request(blueprint_response_attributes: default_response_blueprint_attributes)
      allow_any_instance_of(
        ::Shirty::Http::Printify::Blueprints
      ).to receive(:all).and_return(blueprint_response_attributes)
    end
